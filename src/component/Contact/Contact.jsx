...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_p644ozm', 'template_5fb8lkh', form.current, 'BdL2cPMMIC_371EIb')
      .then((result) => {
  ...
  return (
    <div>
      <div className="container grid grid-cols-1 mt-[500px] lg:mt-20 lg:grid-cols-2 justify-content-center align-items-center">
        <svg className="sss w-[80%] lg:w-full"
        ...
        <form  ref={form} onSubmit={sendEmail}>
          <h1 class="title ml-10 mb-4">Talk to Us</h1>
          ...
          <div class="form-group position-relative">
            ...
            <input
              ...
              id="formName"
              name="formName"
              className="ml-10 w-80 form-control form-control-lg thick"
              placeholder="Name"
            />
          </div>
          ...
          <div class="form-group position-relative">
            ...
            <input
              ...
              id="formEmail"
              name="formEmail"
              className="ml-10 mt-5 mb-5 w-80 form-control form-control-lg thick"
              placeholder="E-mail"
            />
          </div>

          <div className="form-group message w-96">
            <textarea
              id="formMessage"
              name="message"
              className="ml-10 w-80 p-2 form-control form-control-lg"
              rows="7"
              placeholder="Message"
            ></textarea>
          </div>
